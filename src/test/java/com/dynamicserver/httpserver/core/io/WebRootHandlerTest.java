...
import com.dynamicserver.http.HttpParser;
...
public class WebRootHandlerTest {
    ...
    void constructorGoodPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("E:\\Projects\\dynamicserver\\simple-java-http-server\\WebRoot");
    ...
    void constructorBadPath() {
        try {
            WebRootHandler webRootHandler = new WebRootHandler("E:\\Projects\\dynamicserver\\simple-java-http-server\\WebRoot2");
            fail();
        } catch (WebRootNotFoundException e) {
        }
    }
